##30 simple moving average, long term, spy 30 day moving, if price above this average, in an uptrend,
## 80% spy and 20% bnd if price is below 30 SMA, 80% bnd, 20% spy
