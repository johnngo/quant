...
#earn premium against stocks with large capitalization(without additional risk_)
#anomaly best described in the classical fama and french research paper(1993)
#strategy was initally based on the paper by fama and french, the cross section
#of expected returns, but to stay up to date we drew data from a newer paper
# by Alquist, Israel, and Moskowitz, fact, fiction and size effect
#worse liquidity - less institutional
#more room to grow
